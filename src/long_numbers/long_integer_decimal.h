...
namespace lipaboy_lib::long_numbers_space {
    ...
    class LongIntegerDecimal
            //: public ComparatorExtender<LongIntegerDecimal<countOfIntegrals> >
    {
    public:
    ...
    public:
        ...
        auto operator*(LongIntegerDecimal<length2> const & other) const
            -> LongIntegerDecimal<extra2::Max<countOfIntegrals, length2>::value >
        {
            using ResultType = LongIntegerDecimal<extra2::Max<countOfIntegrals, length2>::value >;
            ResultType res(0);
    ...
    private:
	    void checkTemplateParameters() {
		    static_assert(countOfIntegrals > 0, "Wrong length of LongInteger");
	    }
    ...
    private:
        ...
        friend class LongIntegerDecimalView<countOfIntegrals>;
    };
